...
class ExcelUpdater:
    ...
    def add_update(self, data: dict):
        ...
        for header in self.headers:
            ...
            elif header == "Azure Products": value = data.get('product_list') if data.get('provider') == 'Azure' else None
            elif header == "Azure Categories": value = data.get('categories') if data.get('provider') == 'Azure' else None
            elif header == "Azure Status": value = data.get('status') if data.get('provider') == 'Azure' else None
            elif header == "Azure Update Type": value = data.get('update_type') if data.get('provider') == 'Azure' else None
            else: 
